...
int
_gsasl_plain_client_start (Gsasl_session_ctx *cctx, 
			   void **mech_data)
{
  Gsasl_ctx *ctx;
  int *step;
...
int
_gsasl_plain_client_finish (Gsasl_session_ctx *cctx,
			    void *mech_data)
{
  int *step = mech_data;
...
int
_gsasl_plain_server_start (Gsasl_session_ctx *sctx, 
			   void **mech_data)
{
  Gsasl_ctx *ctx;
...
int
_gsasl_plain_server_finish (Gsasl_session_ctx *sctx, 
			    void *mech_data)
{
  return GSASL_OK;
}
