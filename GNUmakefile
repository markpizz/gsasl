...
gnulib.mk:
	...
	ln -s build-aux/GNUmakefile lib/gnulib.mk || cp lib/build-aux/GNUmakefile lib/gnulib.mk
	ln -s build-aux/maint.mk lib/maint.mk || cp lib/build-aux/maint.mk lib/maint.mk
endif
